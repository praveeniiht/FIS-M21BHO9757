...
import com.example.comment.commenteurekaclient.repo.CommentsDao;
...
public class CommentsServiceImpl implements CommentsService{
	...
	List<PostsDto> data=	template.getForObject("http://POST-SERVICE/posts/author/"+comenterName, List.class);
		return data;	
	}
